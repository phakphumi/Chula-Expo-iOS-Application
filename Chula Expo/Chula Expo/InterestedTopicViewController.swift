//
//  InterestedTopicViewController.swift
//  Chula Expo
//
//  Created by Pakpoom on 12/23/2559 BE.
//  Copyright © 2559 Chula Computer Engineering Batch#41. All rights reserved.
//

import UIKit

class InterestedTopicViewController: UIViewController {
    ...
    */
    ...
    func createGradientLayer() {
        ...
        //Begin, define gradient color shade from RGB(204,115,184) to RGB(163,112,191)
        let headGradientColor = UIColor(red: 0.8, green: 0.45, blue: 0.72, alpha: 1).cgColor
        let tailGradientColor = UIColor(red: 0.64, green: 0.44, blue: 0.75, alpha: 1).cgColor
        //
    ...
    func createImageView() {
        ...
        for i in 0..<4 {
            ...
            let dragGestureRecognizer = UIPanGestureRecognizer(target: self, action: #selector(InterestedTopicViewController.wasDragged(gestureRecognizer:)))
            ...
            let tapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(InterestedTopicViewController.wasTapped(gestureRecognizer:)))
