...
class BookTableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var bookmarkButton: UIButton!{
        didSet{
//            let bookmarkIconView = UIImageView(image: #imageLiteral(resourceName: "bookmarkIcon"))
//            bookmarkButton.addSubview(bookmarkIconView)
            ...
            bookmarkButton.imageEdgeInsets = UIEdgeInsets(
                ...
                left: (bookmarkButton.frame.width-imageBounds.width)/2-(imageBounds.width/2),
                bottom: 0,
                right: 0
            )
            bookmarkButton.titleEdgeInsets = UIEdgeInsets(
                top: 0,
                left:(bookmarkButton.frame.width-titleBounds.width)/2 - (1.5*imageBounds.width),
    ...
    @IBOutlet weak var Bookingbutton: UIButton!{
        didSet{
            ...
            Bookingbutton.imageEdgeInsets = UIEdgeInsets(
                top:  -(totalHeight - imageBounds.height),
                left: (Bookingbutton.frame.width-imageBounds.width)/2-(imageBounds.width/2),
                bottom: 0,
                right: 0
            )
            Bookingbutton.titleEdgeInsets = UIEdgeInsets(
                top: 0,
                left:(Bookingbutton.frame.width-titleBounds.width)/2 - (1.5*imageBounds.width),
                bottom: -(totalHeight - titleBounds.height),
                right: 0
            )
