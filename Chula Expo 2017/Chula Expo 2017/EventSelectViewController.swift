...
//                    }
    ...
    func setupFacultyData() {
        ...
        facultyDatas = [
            facultyData(imgName: "heartIcon",  tagName: "ครุศาสตร์",  tagBack: "technology",  tagEngName: "Faculty of Education", shortName: "", tagColor: UIColor.red),
            facultyData(imgName: "heartIcon",  tagName: "จิตวิทยา",  tagBack: "technology",  tagEngName: "Faculty of Psychology", shortName: "", tagColor: UIColor.red),
            facultyData(imgName: "heartIcon",  tagName: "ทันตแพทยศาสตร์",  tagBack: "technology",  tagEngName: "Faculty of Dentistry", shortName: "", tagColor: UIColor.red),
            facultyData(imgName: "heartIcon",  tagName: "นิติศาสตร์",  tagBack: "technology",  tagEngName: "Faculty of Law", shortName: "", tagColor: UIColor.red),
            facultyData(imgName: "heartIcon",  tagName: "นิเทศศาสตร์",  tagBack: "technology",  tagEngName: "Faculty of Communication Arts", shortName: "", tagColor: UIColor.red),
            facultyData(imgName: "heartIcon",  tagName: "พยาบาลศาสตร์",  tagBack: "technology",  tagEngName: "Faculty of Nursing", shortName: "", tagColor: UIColor.red),
            facultyData(imgName: "heartIcon",  tagName: "พาณิชยศาสตร์และการบัญชี",  tagBack: "technology",  tagEngName: "Faculty of Commerce and Accountancy", shortName: "", tagColor: UIColor.red),
            facultyData(imgName: "heartIcon",  tagName: "รัฐศาสตร์",  tagBack: "technology",  tagEngName: "Faculty of Political Science", shortName: "", tagColor: UIColor.red),
            facultyData(imgName: "heartIcon",  tagName: "วิทยาศาสตร์",  tagBack: "technology",  tagEngName: "Faculty of Science", shortName: "", tagColor: UIColor.red),
            facultyData(imgName: "heartIcon",  tagName: "วิทยาศาสตร์การกีฬา",  tagBack: "technology",  tagEngName: "Faculty of Sports Science", shortName: "", tagColor: UIColor.red),
            ...
            facultyData(imgName: "heartIcon",  tagName: "เศรษฐศาสตร์",  tagBack: "technology",  tagEngName: "Faculty of Economic", shortName: "", tagColor: UIColor.red),
            facultyData(imgName: "heartIcon",  tagName: "แพทยศาสตร์",  tagBack: "technology",  tagEngName: "Faculty of Medicine", shortName: "", tagColor: UIColor.red),
            facultyData(imgName: "heartIcon",  tagName: "สำนักวิชาทรัพยากรการเกษตร",  tagBack: "technology",  tagEngName: "School of Agricultural", shortName: "", tagColor: UIColor.red),
            facultyData(imgName: "heartIcon",  tagName: "บัณฑิตวิทยาลัย",  tagBack: "technology",  tagEngName: "Graduate School", shortName: "", tagColor: UIColor.red),
    ]
    }
